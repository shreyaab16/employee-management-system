...
const AllTask = () => {
  ...
  return (
    <div className="bg-[#1c1c1c] p-5 rounded mt-5 overflow-x-auto">
      <div className="bg-[#242424] mb-2 py-2 px-4 flex justify-between rounded min-w-[700px]">
        ...
        {userData &&
          userData.map((elem) => {
            return (
              <div
                key={elem.id}
                className="border border-gray-700 mb-2 py-2 px-4 flex justify-between rounded min-w-[700px]"
              >
